...
char*names[NAMES_COUNT] = {
  ...
  "x051","x052","x053","x054","x055","x056","x057","x058","x059","x060",
  "x061","x062","x063","x064","x065","x066","x067","x068","x069","x070",
  "x071","x072","x073","x074","x075","x076","x077","x078","x079","x080",
  "x081","x082","x083","x084","x085","x086","x087","x088","x089","x090",
  "x091","x092","x093","x094","x095","x096","x097","x098","x099","x100",
  ...
  "x701","x702","x703","x704","x705","x706","x707","x708","x609","x710",
  "x711","x712","x713","x714","x715","x716","x717","x718","x619","x720",
  "x721","x722","x723","x724","x725","x726","x727","x728","x629","x730",
  "x731","x732","x733","x734","x735","x736","x737","x738","x639","x740",
  "x741","x742","x743","x744","x745","x746","x747","x748","x649","x750",
  "x751","x752","x753","x754","x755","x756","x757","x758","x659","x760",
  "x761","x762","x763","x764","x765","x766","x767","x768","x669","x770",
  "x771","x772","x773","x774","x775","x776","x777","x778","x679","x780",
  "x781","x782","x783","x784","x785","x786","x787","x788","x689","x790",
  "x791","x792","x793","x794","x795","x796","x797","x798","x699","x800",
  ...
  "x991","x992","x993","x994","x995","x996","x997","x998","x999","x000",*/
};

int main(){
  tManager mgr;
  tBddNode *x[NAMES_COUNT],  // nodes
    *f,                     // and xor and xor and ...
    *ftmp,                  // and xor and
    *and,                   // xi and xi+1 and ...
    *andtmp;                // xi and xi+1
  int i;
  ...
  for(i = 0;i<NAMES_COUNT;i++) {
    bddCreateNode(&mgr,names[i],bddTrue,bddFalse,&x[i]);
  }
  
  
  for(i = 0; i < NAMES_COUNT-3; i++) {
    and = x[i];
    for(int j = 1; j<4; j++) {
      andtmp = bddApply(&mgr,and,x[i+j],bddAnd);
      nodeDecRef(&mgr,and);
      and = andtmp;
    }
    ftmp = bddApply(&mgr,and,f,bddXor);
    nodeDecRef(&mgr,and);
    nodeDecRef(&mgr,f);
    f = ftmp;
